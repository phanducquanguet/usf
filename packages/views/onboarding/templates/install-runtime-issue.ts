...
runtime이 연결되면 UniAI Helper를 만들어 안내를 받으며 첫 실행을 시작할 수 있습니다.`;
...
runtime が接続されたら、UniAI Helper を作成して、案内付きの最初の実行を始められます。`;
