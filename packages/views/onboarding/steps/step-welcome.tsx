 ...
 *
 * `isWeb` only changes the primary CTA label ("Continue on web" vs
 * "Start exploring") — web is the only supported client right now,
 * so the desktop download CTA is hidden.
 */
