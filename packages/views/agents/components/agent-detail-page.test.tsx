...
vi.mock("@multica/core/workspace/queries", () => ({
  ...
  // Owner-only portal config: resolve as "no portal" so the DM tests are
  // unaffected by portal affordances.
  portalAdminConfigOptions: (wsId: string) => ({
    queryKey: ["portal", "admin-config", wsId],
