...
# Configuration
# ---------------------------------------------------------------------------
$RepoUrl       = "https://github.com/phanducquanguet/usf.git"
$RepoWebUrl    = "https://github.com/phanducquanguet/usf"
...
function Get-LatestVersion {
    try {
        $release = Invoke-RestMethod -Uri "https://api.github.com/repos/phanducquanguet/usf/releases/latest" -ErrorAction Stop
...
function Install-CliBinary {
    ...
    $checksumUrl = "https://github.com/phanducquanguet/usf/releases/download/$latest/checksums.txt"
    try {
...
function Start-LocalInstall {
    ...
    Write-Host '     $env:MULTICA_MODE="stop"; irm https://raw.githubusercontent.com/phanducquanguet/usf/feature/customer-portal/scripts/install.ps1 | iex'
    Write-Host ""
}
