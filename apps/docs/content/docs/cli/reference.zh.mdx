...
The `multica` CLI connects your local machine to UniAI. It handles authentication, workspace management, issue tracking, and runs the agent daemon that executes AI tasks locally.
