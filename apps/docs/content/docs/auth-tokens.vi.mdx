...
Trong sử dụng hằng ngày, bạn chỉ trực tiếp đụng đến hai loại đầu. **Token của [daemon](/daemon-runtimes)** được `uniai daemon login` tự tạo và làm mới — bạn không cần bận tâm đến nó.
