...
- **Nếu lộ, hãy thay URL ngay** — bấm "Rotate URL" trên dòng trigger, hoặc chạy `multica autopilot trigger-rotate-url <autopilot-id> <trigger-id>`. URL cũ ngừng hoạt động ngay.
