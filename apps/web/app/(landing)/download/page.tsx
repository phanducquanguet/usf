...
export const metadata: Metadata = {
  title: "Download UniAI",
  description:
    "Download UniAI for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download UniAI",
    description:
      "Get the UniAI desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
