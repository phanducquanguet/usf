...
var (
	...
	// already connected to a live owner in a DIFFERENT workspace — it
	...
	ErrTeamOwnedByAnotherWorkspace = errors.New("slack: this Slack app is already connected to a different UniAI workspace")
