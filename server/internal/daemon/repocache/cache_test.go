...
func TestCreateWorktreeInstallsCoAuthoredByHook(t *testing.T) {
	...
	expectedTrailer := "Co-authored-by: uniai-agent <github@unicomhub.com>"
...
func TestCreateWorktreeRemovesCoAuthoredByHookWhenDisabled(t *testing.T) {
	...
	commitMsg := string(out)
	if strings.Contains(commitMsg, "Co-authored-by: uniai-agent") {
...
`
	...
	if commitMsg := string(out); strings.Contains(commitMsg, "Co-authored-by: uniai-agent") {
