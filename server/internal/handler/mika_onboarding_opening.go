...
//
//  1. what UniAI is, in one sentence,
...
var mikaOnboardingOpenings = map[string]string{
	"en": `Hi — welcome to %[1]s. UniAI is a workspace where you and AI agents coordinate real work through issues.
...
Pick one below, or just tell me what you want to get done right now.`,
	...
	"zh": `你好，欢迎来到 %[1]s。UniAI 是一个人和 AI 智能体通过任务一起把事情做完的工作区。
...
从下面选一个开始，或者直接告诉我你现在想做成什么。`,
	...
	"ja": `こんにちは。%[1]s へようこそ。UniAI は、人と AI エージェントがタスクを通じて実際の仕事を進めるワークスペースです。
...
下から一つ選ぶか、いま進めたいことをそのまま教えてください。`,
	...
	"ko": `안녕하세요, %[1]s에 오신 걸 환영합니다. UniAI는 사람과 AI 에이전트가 태스크를 통해 실제 일을 함께 진행하는 워크스페이스입니다.
...
아래에서 하나 고르시거나, 지금 해내고 싶은 일을 그대로 말씀해 주세요.`,
	...
	"vi": `Chào bạn — chào mừng đến với %[1]s. UniAI là không gian làm việc nơi bạn và các agent AI phối hợp làm việc thực sự thông qua issue.

Tôi là %[2]s, Chief of Staff của bạn ở đây. Tôi định hình việc cần làm, đưa đúng agent vào việc, và luôn là điểm bắt đầu cho bất cứ điều gì bạn cần.

Chúng ta bắt đầu thế này: bạn nêu một mục tiêu, tôi biến nó thành issue và khởi động với agent phù hợp — còn bạn theo dõi nó chạy.

Chọn một mục bên dưới, hoặc cứ nói ngay điều bạn muốn hoàn thành.`,
}
